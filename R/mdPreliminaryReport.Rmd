...
aq <- read.table("F:/Metabolomics/allAqueousCleaned.txt", header = TRUE, stringsAsFactors = TRUE)

# read all lipids data
lip <- read.table("F:/Metabolomics/allLipidsCleaned.txt", header = TRUE, stringsAsFactors = TRUE)
```
